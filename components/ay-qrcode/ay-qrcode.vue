<template>
	<view :class="modal?'show-qrcode':'hide-qrcode'">
		<view class="box-qrcode" :style="{'margin-left':  marginLeft + 'px'}" @longtap="longtapCode">
			...
			<!-- <canvas class="canvas-qrcode" :canvas-id="qrcode_id"
			 :style="'width:100vw;height:100vh;background:url('+bgimg+') center no-repeat;'"
			 > -->
				<!-- background: url('http://ds.dshuais.com/425708edd0ca6e4610de25b17.png') center no-repeat; -->
				<!-- <img src="http://ds.dshuais.com/425708edd0ca6e4610de25b17.png" alt=""> -->
				<!-- #ifndef MP -->
			...
			saveImageUrl: function() {
				...
				uni.canvasToTempFilePath({
					...
					success: function(res) {
						that.$emit('getImgurl', res.tempFilePath)
					},
					fail:function(err){
						console.log(err)
					}
